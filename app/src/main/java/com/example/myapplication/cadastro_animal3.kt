...
import com.example.myapplication.databinding.ActivityCadastroAnimal3Binding
import com.google.android.material.snackbar.Snackbar
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class cadastro_animal3 : AppCompatActivity() {

    lateinit var binding: ActivityCadastroAnimal3Binding
    private val db = FirebaseFirestore.getInstance()
    private val auth = FirebaseAuth.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCadastroAnimal3Binding.inflate(layoutInflater)
        ...
        binding.button2.setOnClickListener { view ->
            ...
            if(id.isEmpty()){
                ...
                db.collection("Usuarios").document(email).update("pet3",id)
